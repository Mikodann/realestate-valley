...
function PopulationMoveDistrictChart({ mob }) {
  ...
  const GU_COORDS = {
    '종로구':[37.5850,126.9700],'중구':[37.5500,127.0050],'용산구':[37.5200,126.9850],
    '성동구':[37.5550,127.0450],'광진구':[37.5400,127.0900],'동대문구':[37.5850,127.0500],
    '중랑구':[37.6100,127.1000],'성북구':[37.6000,127.0100],'강북구':[37.6400,127.0200],
    '도봉구':[37.6800,127.0400],'노원구':[37.6600,127.0700],'은평구':[37.6150,126.9200],
    '서대문구':[37.5800,126.9300],'마포구':[37.5600,126.8900],'양천구':[37.5200,126.8550],
    '강서구':[37.5550,126.8350],'구로구':[37.4900,126.8750],'금천구':[37.4500,126.8950],
    '영등포구':[37.5250,126.9050],'동작구':[37.5050,126.9400],'관악구':[37.4700,126.9500],
    '서초구':[37.4750,127.0350],'강남구':[37.5200,127.0600],'송파구':[37.5100,127.1150],
    '강동구':[37.5400,127.1350],
  };
